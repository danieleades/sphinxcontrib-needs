...
def process_needgantt(app, doctree, fromdocname):
    ...
    for node in doctree.traverse(Needgantt):
        ...
        if (
            current_needgantt["timeline"] is not None
            and current_needgantt["timeline"] != ""
        ):
        ...
        for need in found_needs:
            ...
            if (
                current_needgantt["milestone_filter"] is None
                or current_needgantt["milestone_filter"] == ""
            ):
                is_milestone = False
            else:
        ...
        if (
            current_needgantt["align"] is not None
            and len(current_needgantt["align"]) != ""
        ):
        ...
        if (
            current_needgantt["caption"] is not None
            and len(current_needgantt["caption"]) != ""
        ):
            ...
            flow_ref = nodes.reference(
                "t", current_needgantt["caption"], refuri=img_locaton
            )
